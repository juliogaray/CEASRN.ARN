...
### 1.1 Ubicaciones de borde *(Edge Locations)* ![\[Icono de Edge Location\]](https://juliogaray.github.io/CEASRN.ARN/docs/imgEdgeLocation.svg)
...
### 1.2 AWS Outposts ![\[Icono de AWS Outpost\]](https://juliogaray.github.io/CEASRN.ARN/docs/imgOutposts.svg)
...
### 1.3 AWS Wavelength ![\[Icono de AWS Wavelength\]](https://juliogaray.github.io/CEASRN.ARN/docs/imgWavelength.svg)
...
### 3.1 Exigencias de Netflix  ![\[Icono de Netflix\]](https://juliogaray.github.io/CEASRN.ARN/docs/imgNetflix_2015_N_logo.svg)
...
### 3.2 Solución con Amazon CloudFront ![\[Icono de CloudFront\]](https://juliogaray.github.io/CEASRN.ARN/docs/imgCloudFront.svg)
