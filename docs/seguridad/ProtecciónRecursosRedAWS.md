...
## 1. AWS Network Firewall: Protección avanzada a nivel de red ﻿![Icono de AWS Network Firewall](https://juliogaray.github.io/CEASRN.ARN/docs/imgAWSNetworkFirewall.svg)
...
Los **Security Groups** son un componente fundamental para controlar el tráfico de red hacia y desde las instancias EC2 y otros servicios compatibles. Actúan como un cortafuegos virtual que define reglas de entrada y salida basadas en características específicas del tráfico.
 ...
 ﻿![Esquema de red en AWS con Security Groups y NACL](https://juliogaray.github.io/CEASRN.ARN/docs/imgSecurityGroupsYNACL.svg)
...
### AWS Firewall Manager ﻿![Icono de AWS Network Firewall](https://juliogaray.github.io/CEASRN.ARN/docs/imgFirewallManager.svg)
...
### AWS Shield ﻿![Icono de AWS Network Firewall](https://juliogaray.github.io/CEASRN.ARN/docs/imgAWSShield.svg)
...
### AWS WAF (Web Application Firewall) ﻿![Icono de AWS Network Firewall](https://juliogaray.github.io/CEASRN.ARN/docs/imgAWSWAF.svg)
