...
## 1. AWS Network Firewall: Protección avanzada a nivel de red ﻿![Icono de AWS Network Firewall](http://julio.iespacomolla.es/CEARSN.ARN/imágenes/AWSNetworkFirewall.svg)
...
Los **Security Groups** son un componente fundamental para controlar el tráfico de red hacia y desde las instancias EC2 y otros servicios compatibles. Actúan como un cortafuegos virtual que define reglas de entrada y salida basadas en características específicas del tráfico.
 ...
 ﻿![Esquema de red en AWS con Security Groups y NACL](http://julio.iespacomolla.es/CEARSN.ARN/imágenes/SecurityGroupsYNACL.svg)
...
### AWS Firewall Manager ﻿![Icono de AWS Network Firewall](http://julio.iespacomolla.es/CEARSN.ARN/imágenes/FirewallManager.svg)
...
### AWS Shield ﻿![Icono de AWS Network Firewall](http://julio.iespacomolla.es/CEARSN.ARN/imágenes/AWSShield.svg)
...
### AWS WAF (Web Application Firewall) ﻿![Icono de AWS Network Firewall](http://julio.iespacomolla.es/CEARSN.ARN/imágenes/AWSWAF.svg)
