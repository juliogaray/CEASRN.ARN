...
Para esta práctica realizaremos el curso *Getting Started with Amazon GuardDuty*, a través de la plataforma [*Skill Builder*](https://skillbuilder.aws/) de Amazon.

El curso es corto (1 hora) y sencillo, pero... está en inglés. No he visto ninguna opción para cambiar el idioma :confused:
...
### Entrega
Deberás elaborar y entregar un único archivo PDF con todo lo especificado a continuación, incluidos los 3 esquemas de red:
