...
## 2. Virtual Private Cloud ![Icono de VPC](https://juliogaray.github.io/CEASRN.ARN/docs/img/VPC.svg) 
...
### 5.1 Puerta de enlace a Internet *(Internet Gateway)* ![Icono de Internet Gateway](https://juliogaray.github.io/CEASRN.ARN/docs/img/VpcInternetGateway.svg)
...
#### Puerta de enlace NAT a Internet *(Internet NAT Gateway)* ![Icono de Internet NAT Gateway](https://juliogaray.github.io/CEASRN.ARN/docs/img/VpcNatGateway.svg)
