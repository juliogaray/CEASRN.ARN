...
## 2. Virtual Private Cloud ![Icono de VPC](../img/VPC.svg) 
...
### 5.1 Puerta de enlace a Internet *(Internet Gateway)* ![Icono de Internet Gateway](../img/VpcInternetGateway.svg)
...
#### Puerta de enlace NAT a Internet *(Internet NAT Gateway)* ![Icono de Internet NAT Gateway](../img/VpcNatGateway.svg)
