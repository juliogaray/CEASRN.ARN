...
## 2. Virtual Private Cloud ![Icono de VPC](http://julio.iespacomolla.es/CEARSN.ARN/imágenes/VPC.svg) 
...
### 5.1 Puerta de enlace a Internet *(Internet Gateway)* ![Icono de Internet Gateway](http://julio.iespacomolla.es/CEARSN.ARN/imágenes/VpcInternetGateway.svg)
...
#### Puerta de enlace NAT a Internet *(Internet NAT Gateway)* ![Icono de Internet NAT Gateway](http://julio.iespacomolla.es/CEARSN.ARN/imágenes/VpcNatGateway.svg)
