...
﻿![Modalidades de acceso remoto a VPN](../img/AccesoRemoto.svg)

Las principales opciones de conectividad incluyen:

## 1. Conexiones *Site-to-Site:* túneles VPN empresariales

### **AWS *Site-to-Site* VPN** ![Icono de conexión AWS site-to-site](../img/SiteToSiteVPN.svg)
...
### **AWS Client VPN** ![Icono de conexión AWS VPN](../img/ClientVPNEndpoint.svg)
...
## 3. Conexiones dedicadas: *AWS Direct Connect* ![Icono de conexión AWS Direct Connect](../img/DirectConnect.svg)
...
- **Directamente en una VPC a través de una Virtual Private Gateway (VGW)** ![Icono de VGW](../img/VGW.svg)
...
- **A través de una Direct Connect Gateway (DXGW)** ![Icono de DXGW](../img/DXGW.svg)
   - Permite conectar una única línea *Direct Connect* a **múltiples VPC en diferentes regiones** (dentro de la misma cuenta de AWS).  

- **A través de una Transit Gateway (TGW)** ![Icono de TGW](../img/TransitGateway.svg)
